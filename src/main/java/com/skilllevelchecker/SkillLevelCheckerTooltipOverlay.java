...
@Singleton
public class SkillLevelCheckerTooltipOverlay extends Overlay
{
    private final Client client;
    private final SkillLevelCheckerPlugin plugin;
    private final SkillLevelCheckerConfig config;
    ...
    @Inject
    public SkillLevelCheckerTooltipOverlay(Client client, SkillLevelCheckerPlugin plugin, SkillLevelCheckerConfig config)
    {
        this.client = client;
        this.plugin = plugin;
        this.config = config;
